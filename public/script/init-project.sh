...
git clone https://github.com/rothfels/pdjd.git $SLUG
cd $SLUG
rm -rf .git

sed -i.bak "s/pdjd/$SLUG/g" **/*.tf
sed -i.bak "s/pdjd/$SLUG/g" **/*.ts
sed -i.bak "s/pdjd/$SLUG/g" **/*.yml
sed -i.bak "s/pdjd/$SLUG/g" **/*.sh
sed -i.bak "s/pdjd/$SLUG/g" **/*.json
rm -rf **/*.bak
