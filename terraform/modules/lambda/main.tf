...
# Lambda URIs are "{+lambda}/{+function}" e.g. "pdjd/ping".
# We also support path matching at the root e.g. "pdjd" but these require definining separate "_root" terraform resources.
