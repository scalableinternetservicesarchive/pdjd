...
usage="Usage: deploy-ecs.sh [pdjd-app-web|pdjd-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/pdjd:$2"
...
aws ecs update-service --cluster pdjd \
  --no-cli-pager \
  --region "$ecs_region" \
